...
return {
  ...
  opts = function(_, opts)
    ...
    maps.n["<Leader>pp"] = { function() require("lazy").profile() end, desc = "Plugins Profile" }
    ...
    maps.n["]b"] = { function() require("astrocore.buffer").nav(vim.v.count1) end, desc = "Next buffer" }
    maps.n["[b"] = { function() require("astrocore.buffer").nav(-vim.v.count1) end, desc = "Previous buffer" }
    maps.n[">b"] = { function() require("astrocore.buffer").move(vim.v.count1) end, desc = "Move buffer tab right" }
    maps.n["<b"] = { function() require("astrocore.buffer").move(-vim.v.count1) end, desc = "Move buffer tab left" }
