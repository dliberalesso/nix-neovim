...
return {
  {
    dir = vim.env.LAZY_ROOT_DIR .. "/mini.ai",
    event = "User AstroFile",
    config = true,
  },
  {
    dir = vim.env.LAZY_ROOT_DIR .. "/mini.bufremove",
  },
  {
    dir = vim.env.LAZY_ROOT_DIR .. "/mini.surround",
    dependencies = {
      { dir = vim.env.LAZY_ROOT_DIR .. "/astroui", opts = { icons = { Surround = "󰑤" } } },
      {
